...
namespace section3.exercises
{
    class ExercisesPart1
    {
        ...
        public static void Ex6()
        {
            ...
            Console.Write("\nDigite 3 valores com ponto flutuante de dupla precisão: ");
            string[] floatValues = Console.ReadLine().Split(' ');

            double A = double.Parse(floatValues[0], CultureInfo.InvariantCulture);
            double B = double.Parse(floatValues[1], CultureInfo.InvariantCulture);
            double C = double.Parse(floatValues[2], CultureInfo.InvariantCulture);
            double PI = 3.14159;
            ...
            Console.WriteLine("CÍRCULO: " + circle.ToString("F3", CultureInfo.InvariantCulture));
